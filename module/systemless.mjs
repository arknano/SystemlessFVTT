...
import { SystemlessActor } from './documents/actor.mjs';
import { SystemlessItem } from './documents/item.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Item.documentClass = SystemlessItem;
...
//   const command = `game.systemless.rollItemMacro("${data.uuid}");`;
...
//       img: item.img,
//       command: command,
//       flags: { 'systemless.itemMacro': true },
//     });
//   }
